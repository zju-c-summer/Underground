    ...
    QWidget(parent)
{
    ...
    carouse->setGeometry(0,0,1000,850);
    carouse->hide();
...
void interface::initWidgets()
{
    ...
    probar->setGeometry(50,900,900,20);
    ...
    Title->setGeometry(200, 100, 800, 200);
    ...
    startbutton->setGeometry(700,550,200,100);
    ...
    exitbutton->setGeometry(700,650,200,100);
